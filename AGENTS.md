...
This project is indexed by GitNexus as **node-oai-structured-output** (77 symbols, 142 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/node-oai-structured-output/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/node-oai-structured-output/context` | Codebase overview, check index freshness |
| `gitnexus://repo/node-oai-structured-output/clusters` | All functional areas |
| `gitnexus://repo/node-oai-structured-output/processes` | All execution flows |
| `gitnexus://repo/node-oai-structured-output/process/{name}` | Step-by-step execution trace |
